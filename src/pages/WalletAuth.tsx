...
import TelegramConfigChecker from "../components/TelegramConfigChecker";
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex items-center justify-center h-16 bg-gradient-to-r from-purple-800 to-violet-800, text-white text-2xl font-bold relative">
        <Link to="/" className="absolute left-6 text-white hover:text-gray-200 transition-colors">
          <FaHome size={24} />
        </Link>
        Select Your Wallet
      </div>
